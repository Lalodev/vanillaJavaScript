export function ContactForm() {
    ...
    $form.innerHTML = `
        ...
        <input type="text" name="name" placeholder="Escribe tu nombre"
            title="Nombre solo acepta letras y espacios en blanco" pattern="^[A-Za-zÑñÁáÉéÍíÓóÚúÜü\\s]{1,50}$" required>
        ...
        <textarea name="comments" cols="50" rows="5" placeholder="Escribe tus comentarios"
            title="Tu comentario no debe exceder los 255 caracteres" data-pattern="^(\n|.){1,255}$" required></textarea>
        <input type="submit" value="Enviar">
        <div class="contact-form-loader none">
            <img src="app/assets/loader.svg" alt="">
        </div>
    ...
    async function validationsForm() {
            ...
            d.addEventListener("submit", (e) => {
                ...
                fetch("https://formsubmit.co/ajax/laloing87@gmail.com", {
                    method: "POST",
